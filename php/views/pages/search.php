                    ...
                    <a href="show.php?id=<?php echo htmlspecialchars($pokemon['ID']); ?>">
                        ...
                        <div class="poke-details">
                            ...
                            <div class="poke-types">
                                <span
                                    class="<?php echo htmlspecialchars($pokemon['type1']); ?>"><?php echo htmlspecialchars($pokemon['type1']); ?></span>
                                <?php if (!empty($pokemon['type2'])): ?>
                                    <span
                                        class="<?php echo htmlspecialchars($pokemon['type2']); ?>"><?php echo htmlspecialchars($pokemon['type2']); ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
                    </a>
